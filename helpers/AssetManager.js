...
const { uploadsPath } = require(APP_PATH + '/helpers/ConfigHelper.js');

// Directory uploads (assets) are stored in. Configurable through the `uploadsDir`
// config.json property, overridable through the WEBSTRATES_UPLOADS_DIR environment
// variable
module.exports.UPLOAD_DEST = uploadsPath();
fs.mkdirSync(module.exports.UPLOAD_DEST, { recursive: true });
